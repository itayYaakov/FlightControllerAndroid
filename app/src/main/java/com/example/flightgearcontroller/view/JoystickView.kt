...
//        }
    ...
    private fun drawStick(event: MotionEvent) {
        ...
        angle = calculateAngle(positionX.toFloat(), (positionY * (-1)).toFloat()).toFloat()
            ...
            MotionEvent.ACTION_MOVE -> {
                if (touchState) {
                    ...
                    if (distance <= maxX) {
                        ...
                        val posAngle = calculateAngle(positionX.toFloat(), positionY.toFloat())
    ...
    inner class DrawCanvas constructor(mContext: Context?) :
        ...
        public override fun onDraw(canvas: Canvas) {
            ...
            paint2.textSize = 40f
            canvas.drawText("DIS=%f".format(distance), x.toFloat(), y.toFloat(), paint2)
            canvas.drawText("ANG=%f".format(angle), x.toFloat(), y.toFloat() - 30, paint2)
        }
